...
$guide_types = array( "Course", "How-to", "Special topics", "Internal", "A-Z only" );
...
$all_ctags = array( "Articles", "Ebooks", "Español", "Images", "Newspapers", "Streaming_media", "Test_prep", "New_Databases");
...
$all_bgs = array("basic", "blue", "books", "cape_creek_bridge", "cool_dog", "face_towers", "flocking", "freezing", "metamorphosis", "nasa", "ocean_and_clouds", "snow", "tumalo_falls");
...
$pluslets_activated = array("Basic", "Heading", "LinkList", "FindIt", "ContactUs", "Card", "HTML5Video", "SubjectSpecialist", "4", "Feed", "AccessibilityStatement", "WorldCat", "GoogleScholar", "GoogleSearch",  "Related", "TOC", "2", "1", "LibChat", "BookList", "GuideSearch");
...
$administrator_email = "libref@linnbenton.edu";
...
/* MySQL hostname.  Usually "localhost", but could be, say,
   mysql.yourhost.edu */
$hname = getenv('sp_db_hname');

/* MySQL username and password */
$uname = getenv('sp_db_uname');
$pword = getenv('sp_db_pword');
...
$dbName_SPlus = getenv('sp_db_name');
...
$collection_thumbnail = "default.png";
...
$open_string = "https://libcat.linnbenton.edu/eg/opac/results?detail_record_view=1&query=";
$close_string = "";

// Keyword Search
$open_string_kw = "https://libcat.linnbenton.edu/eg/opac/results?detail_record_view=1&query=";
$close_string_kw = "";

// Call Number (DVDs and Reserves only)

$open_string_cn = "https://libcat.linnbenton.edu/eg/opac/cnbrowse?locg=8&cn=";
$close_string_cn = "";

// Bib

$open_string_bib = "https://libcat.linnbenton.edu/eg/opac/record/";

/* String which should be prepended if you use a proxy server
   e.g. http://ezproxy.yourcampus.edu:2048/login?url=   */
$proxyURL = "https://ezproxy.libweb.linnbenton.edu/login?url=";
